...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    password_confirm = serializers.CharField(
        write_only=True, style={"input_type": "password"}, help_text=_("Confirm your password")
    )
...
class UserLoginSerializer(serializers.Serializer):
    ...
    email = serializers.EmailField(help_text=_("Enter your email address"))

    password = serializers.CharField(
        write_only=True, style={"input_type": "password"}, help_text=_("Enter your password")
    )
...
class PasswordChangeSerializer(serializers.Serializer):
    ...
    new_password_confirm = serializers.CharField(
        write_only=True, style={"input_type": "password"}, help_text=_("Confirm your new password")
    )
...
class UserProfileUpdateSerializer(serializers.ModelSerializer):
    ...
    def validate_linkedin(self, value):
        ...
        if value and "linkedin.com" not in value.lower():
            raise serializers.ValidationError(_("Please enter a valid LinkedIn profile URL."))
        return value

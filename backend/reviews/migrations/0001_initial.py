    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tenant', models.ForeignKey(help_text='The tenant who wrote this review', limit_choices_to={'student_profile__isnull': False}, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Review',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['review'], name='reviews_rev_review__209121_idx'),
        ),
        migrations.AddIndex(
            model_name='reviewhelpfulness',
            index=models.Index(fields=['user'], name='reviews_rev_user_id_ab7920_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='reviewhelpfulness',
        ...
        migrations.AddIndex(
            model_name='reviewreport',
            index=models.Index(fields=['reporter'], name='reviews_rev_reporte_c82420_idx'),
        ),
        migrations.AddIndex(
            model_name='reviewreport',
            index=models.Index(fields=['is_resolved'], name='reviews_rev_is_reso_d36d0a_idx'),
        ),
        migrations.AddIndex(
            model_name='reviewreport',
            index=models.Index(fields=['created_at'], name='reviews_rev_created_16c7fc_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='reviewreport',

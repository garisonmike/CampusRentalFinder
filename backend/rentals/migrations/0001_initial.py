# Generated by Django 5.2.17 on 2026-08-24 18:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('landlord', models.ForeignKey(help_text='Property owner/landlord', limit_choices_to={'landlord_profile__isnull': False}, on_delete=django.db.models.deletion.CASCADE, related_name='rental_properties', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tenant', models.ForeignKey(limit_choices_to={'student_profile__isnull': False}, on_delete=django.db.models.deletion.CASCADE, related_name='rental_inquiries', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='rentalfavorite',
            index=models.Index(fields=['user'], name='rentals_ren_user_id_b70bdb_idx'),
        ),
        migrations.AddIndex(
            model_name='rentalfavorite',
            index=models.Index(fields=['rental'], name='rentals_ren_rental__89557c_idx'),
        ),
        migrations.AddIndex(
            model_name='rentalfavorite',
            index=models.Index(fields=['created_at'], name='rentals_ren_created_706800_idx'),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['rental', 'is_primary'], name='rentals_ren_rental__af2708_idx'),
        ),
        migrations.AddIndex(
            model_name='rentalimage',
            index=models.Index(fields=['rental', 'order'], name='rentals_ren_rental__8d9be6_idx'),
        ),
        migrations.AddIndex(
            model_name='rentalinquiry',
            index=models.Index(fields=['rental'], name='rentals_ren_rental__f610a8_idx'),
        ),
        migrations.AddIndex(
            model_name='rentalinquiry',
            index=models.Index(fields=['tenant'], name='rentals_ren_tenant__71f5c8_idx'),
        ),
        migrations.AddIndex(
            model_name='rentalinquiry',
            index=models.Index(fields=['status'], name='rentals_ren_status_662975_idx'),
        ),
        migrations.AddIndex(
            model_name='rentalinquiry',
            index=models.Index(fields=['created_at'], name='rentals_ren_created_cb0d32_idx'),
        ),
    ]
